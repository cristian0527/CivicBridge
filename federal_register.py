...
class FederalRegisterClient:
    ...
    def get_document_details(self, document_number: str) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.info(f"Retrieved document details for: {document_number}")
            return document
    ...
    def format_document_for_explanation(self, document: Dict[str, Any]) -> str:
        ...
        agency_names = ', '.join([agency.get('name', '') for agency in document.get('agencies', [])])
...
if __name__ == "__main__":
    ...
    try:
        ...
        if healthcare_docs:
            ...
            print(f"Agency: {', '.join([a.get('name', '') for a in first_doc.get('agencies', [])])}")
